 ...
 */
import { CLOBEngine } from '../clob/index.js';
...
export class MarketManager {
    ...
    private clobEngines: Map<number, CLOBEngine> = new Map();
     ...
     */
    startMarket(marketId: number, priceAtStart: number): CLOBEngine {
        ...
        const engine = new CLOBEngine(marketId, sessionId);
     ...
     */
    getCLOB(marketId: number): CLOBEngine | undefined {
